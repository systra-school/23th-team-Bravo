/**
 * ファイル名：WorkRecordInputInitAction.java
 *
 * 変更履歴
 ...
 *
 */
public class WorkRecordInputInitAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
     ...
     // セッションから合計時間を削除
        ...
        // フォーム
        WorkRecordInputForm workRecordInputForm = (WorkRecordInputForm) form;
