/**
 * ファイル名：WorkRecordCheckInitAction.java
 *
 * 変更履歴
 ...
 *
 */
public class WorkRecordCheckInitAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        workRecordForm.setEmployeeCmbMap(employeeCmbMap);
        workRecordForm.setEmployeeId(loginUserDto.getEmployeeId());
        workRecordForm.setEmployeeName(loginUserDto.getEmployeeName());
