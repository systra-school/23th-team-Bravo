...
public class BaseShiftDao extends Dao {
    ...
    public Map<String, BaseShiftDto> getBaseShiftDataList() throws SQLException {
        ...
        try {
            ...
            strSql.append("   emp.employee_id     ");//2024/09/07/尾崎/emp.employee_idに変更
            ...
            while (rs.next()) {
                ...
                baseShiftDto.setShiftIdOnMonday   (rs.getString(M_base_shift.MONDAY.getName()));            // 月曜日シフトＩＤ //2024/09/04/宮平力斗/月曜日シフトが不足していたので追加。
